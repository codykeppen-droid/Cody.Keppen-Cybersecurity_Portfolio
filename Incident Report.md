...
| **Review** | **NIST SP 800-53: AC-6** addresses the concept of Least Privilege. It gives the concept of only allowing the least amount of accesses necessary for an individual to complete their functions. While also providing controls to implement to mitigate the risks associated with data access. These controls are: \<ul\>\<li\>Restrict access to sensitive resources based on user role.\</li\>\<li\>Automatically revoke access to information after a period of time.\</li\>\<li\>Keep activity logs of provisioned user accounts.\</li\>\<li\>Regularly audit user privileges.\</li\>\</ul\> |
